...
export const UserActions = () => {
  ...
  return (
    <div className="flex items-center gap-[12px] xl:gap-[40px]">
      <div className="xl:bg-category-background h-[24px] bg-white xl:flex xl:h-[48px] xl:w-[577px] xl:items-center xl:justify-evenly xl:rounded-[62px] xl:px-[8px] xl:py-[6px] xl:text-stone-300">
